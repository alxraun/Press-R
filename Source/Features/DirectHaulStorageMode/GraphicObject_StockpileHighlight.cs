...
namespace Microtools.Features.DirectHaulStorageMode
{
            ...
            IHasTarget<Zone_Stockpile>
    {
        ...
        private List<IntVec3> _cachedCells = [];
        private Map _map;
        ...
        public void Render()
        {
            ...
            DrawUtils.DrawThinFieldEdges(_cachedCells, _lineMaterial, padding: Padding);
        }
