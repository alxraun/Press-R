...
namespace PressR.Features.StorageLens
{
    public sealed class GraphicObject_ThingOverlay : IGraphicObject, IHasColor, IHasAlpha
    {
        ...
        private Color _lastAppliedColor = new(-1f, -1f, -1f, -1f);
        ...
        public object Key => (_targetThing, typeof(GraphicObject_ThingOverlay));

        public GraphicObject_ThingOverlay(Thing targetThing)
        {
