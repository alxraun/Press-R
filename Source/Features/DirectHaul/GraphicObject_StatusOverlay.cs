...
namespace Microtools.Features.DirectHaul
{
            ...
            System.IDisposable
    {
        ...
        private static readonly Vector3 BaseCarriedOffset = new(0.0f, 0.0f, -0.1f);
        ...
        public object Key => (_targetThing, typeof(GraphicObject_StatusOverlay));
        ...
        public GraphicObject_StatusOverlay(Thing targetThing)
        {
            _targetThing =
        ...
        public void UpdateTexturePath(string texturePath)
        {
        ...
        private Vector3? CalculatePositionWhenCarriedByPawn(Pawn pawn)
        {
            ...
            Vector3 itemCenterPos = new(finalX, targetY, finalZ);
        ...
        public void Render()
        {
            ...
            Vector3 scale = new(overlayGraphicSize, 1f, overlayGraphicSize);
