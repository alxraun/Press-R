...
namespace PressR.Features.DirectHaul.Graphics
{
    ...
    public class DirectHaulGhostGraphicObject : IGraphicObject, IHasColor, IHasAlpha, IHasPosition
    {
        ...
        private Color _lastAppliedFillColor = new Color(-1f, -1f, -1f, -1f);
        private Color _lastAppliedOutlineColor = new Color(-1f, -1f, -1f, -1f);
        ...
        public DirectHaulGhostGraphicObject(
            Thing targetThing,
            GhostType ghostType,
