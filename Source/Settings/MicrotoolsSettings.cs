...
{
    public class MicrotoolsSettings : ModSettings
    {
        ...
        public override void ExposeData()
        {
            ...
            if (Scribe.mode == LoadSaveMode.LoadingVars)
            {
                ...
                {
                    Log.Warning(
                        "Microtools TabLensSettings failed to load, resetting to defaults."
                    );
                    storageLensSettings = new StorageLensSettings();
                }
                ...
                {
                    Log.Warning(
                        "Microtools DirectHaulSettings failed to load, resetting to defaults."
                    );
                    directHaulSettings = new DirectHaulSettings();
                }
            }
